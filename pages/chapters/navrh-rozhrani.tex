...
\begin{figure}[hbt]
    \centering
    \includegraphics[width=0.8\textwidth]{\FIGDIR/ui-user-story-1}
...
\begin{figure}[hbt]
    \centering
    \includegraphics[width=0.8\textwidth]{\FIGDIR/ui-user-story-2}
    \caption{Návrh komponent pro výběr sedadel}
    \label{fig:ui-user-story-2}
\end{figure}

Na obrázku~\ref{fig:ui-user-story-2} TODO
...
\begin{figure}[hbt]
    \centering
    \includegraphics[width=0.8\textwidth]{\FIGDIR/ui-user-story-3}
...
%%% TODO: Podsekce - Vyřízení objednávky
%%% --------------------------------------------------------------
