...
V moderním vývoji webových aplikací využívají frontendoví vývojáři sofistikované knihovny a frameworky, jako jsou \textbf{React.js}, \foreign{Angular}, \foreign{Vue.js} k vytváření složitých a interaktivních uživatelských rozhraní\cite{mdn_tools_and_testing_client_side_javascript_frameworks_introduction}.
