...
\foreign{State}, neboli počeštěně stav, košíku je spravován globálně v celé aplikaci pomocí kontextu.
...
Tyto akce, reprezentované tzv. \foreign{handlery}, zahrnují \texttt{addToCartHandler()}, \texttt{removeFromCartHandler()} a \texttt{replaceCartedTicketHandler()}.
...
Toho je dosaženo voláním asynchronní funkce, která vrací \foreign{promise}, který se vyřeší po nějaké době.
