...
Pro zajištění kvality kódu v tomto projektu byly vybrány dva klíčové nástroje: \foreign{Prettier} a \foreign{ESLint}.
...
V tomto projektu bylo pro účely správy komunikace se serverem využito knihoven \foreign{Axios} a \foreign{React Query}.
...
Pro správu formulářů v aplikaci byly použity knihovny \foreign{React Hook Form} a \foreign{Zod}.

\textbf{React Hook Form} je knihovna pro správu formulářů v Reactu, která snižuje množství \foreign{boilerplate}\footnote{\foreign{Boilerplate} je označení pro kód, který je nezbytný, aby bylo možné vykonat určitou akci. V tomto případě se jedná o nezbytný kód pro vytváření formulářů.} kódu potřebného pro vytváření formulářů.
