...
\nobreak\vbox to 0.49\vsize{
    ...
    %%% text anglicky
    \noindent
    This bachelor's thesis deals with the development of an intuitive, user-oriented ticketing system with seat reservation from a frontend perspective with an emphasis on an interactive seat map.
