...
%%%%% TODO:
%% - [] zrevidovat a přejmenovat kapitolu specifikace
%% - [] dopsat závěr
%% - [] přepsat úvod logicky
%% - [] napsat abstrakt
%% - [] dopsat kapitolu architektura řešení
%% - [] přidat diagramy a lepší strukturu/dokumentaci komponent
%% - [] přidat přílohy
%% - [] upravit poděkování
...
%%% jednotlivé kapitoly
    ...
    % TODO: kapitola - identifikace klíčových částí
